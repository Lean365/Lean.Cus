...
// </auto-generated>
//
// <copyright file="LeanMenuDto.cs" company="Lean365">
...
public class LeanMenuExportDto
{
    ...
    /// 是否缓存
    /// </summary>
    public string IsCacheName { get; set; } = string.Empty;
...
public class LeanMenuImportTemplateDto
{
    ...
    /// 是否缓存（0/1）
    /// </summary>
    public string IsCache { get; set; } = "否";

    /// <summary>
    /// 是否外链（0/1）
    /// </summary>
    public string IsFrame { get; set; } = "否";
